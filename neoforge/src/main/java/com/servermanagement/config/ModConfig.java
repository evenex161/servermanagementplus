...
public class ModConfig {
    ...
    // Server Performance Settings
        public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue SHOW_MARKET_VALUE_TOOLTIPS;
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue MINEBAY_ENABLED;
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue MINESTACKS_ENABLED;
    public static ModConfigSpec.ConfigValue<String> TRADE_BLACKLIST;
