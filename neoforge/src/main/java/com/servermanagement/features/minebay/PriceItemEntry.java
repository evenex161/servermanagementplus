...
public class PriceItemEntry {
    ...
    public static PriceItemEntry fromNBT(CompoundTag tag) {
        ...
        entry.itemStack = com.servermanagement.util.NbtHelper.loadItemStack(tag.getCompoundOrEmpty("Item"), net.neoforged.neoforge.server.ServerLifecycleHooks.getCurrentServer().registryAccess());
