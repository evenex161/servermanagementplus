...
public class EconomyManagementMenu extends AbstractContainerMenu {
    ...
    public EconomyManagementMenu(int containerId, Inventory playerInventory) {
        super(com.servermanagement.gui.ModMenuTypes.ECONOMY_MANAGEMENT_MENU.get(), containerId);
    }
    ...
    public boolean stillValid(Player player) {
        if (player instanceof net.minecraft.server.level.ServerPlayer serverPlayer) {
            return serverPlayer.permissions().hasPermission(net.minecraft.server.permissions.Permissions.COMMANDS_MODERATOR);
        }
