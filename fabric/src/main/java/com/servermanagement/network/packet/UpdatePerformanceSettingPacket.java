...
public record UpdatePerformanceSettingPacket(String settingKey, String value, long clientTick) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "update_performance_setting_packet");
