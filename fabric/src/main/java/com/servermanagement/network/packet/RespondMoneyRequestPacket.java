 ...
 */
public record RespondMoneyRequestPacket(UUID requestId, Action action) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "respond_money_request_packet");
