...
public record SaveEconomySettingsPacket(boolean showMarketValueTooltips, boolean minebayEnabled, boolean minestacksEnabled, String tradeBlacklist, double startingBalance) implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
