 ...
 */
public record AcceptOfferPacket(String listingId, String offerId) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "accept_offer_packet");
