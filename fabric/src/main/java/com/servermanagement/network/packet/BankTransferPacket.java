 ...
 */
public record BankTransferPacket(String targetPlayerName, double amount) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "bank_transfer_packet");
