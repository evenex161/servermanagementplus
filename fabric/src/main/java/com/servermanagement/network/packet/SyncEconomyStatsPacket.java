 ...
 */
public record SyncEconomyStatsPacket(int totalAccounts, double totalMoneyInCirculation, double averageBalance, double richestBalance, String richestPlayerName, double inflationMultiplier, int activeListings, int totalTemplates, int enabledTemplates, int totalTransactions, int purchaseCount, int saleCount, int gamblingBetCount, int gamblingWinCount, int freeRewardCount, int transferCount, double totalPurchaseVolume, double totalSaleVolume, double totalGamblingWagered, double totalGamblingWon) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "sync_economy_stats_packet");
