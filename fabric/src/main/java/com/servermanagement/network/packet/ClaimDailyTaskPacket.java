 ...
 */
public record ClaimDailyTaskPacket(int taskIndex) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "claim_daily_task_packet");
