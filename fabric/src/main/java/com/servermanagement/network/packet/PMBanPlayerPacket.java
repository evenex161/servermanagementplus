...
public record PMBanPlayerPacket(String playerName, String reason, boolean banIP) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "p_m_ban_player_packet");
