 ...
 */
public record ModFileCompletePacket(String fileHash, long fileSize, String version, boolean success, String message) implements com.servermanagement.network.IPacket {
    public static final net.minecraft.resources.ResourceLocation ID = new net.minecraft.resources.ResourceLocation("servermanagement", "mod_file_complete_packet");
