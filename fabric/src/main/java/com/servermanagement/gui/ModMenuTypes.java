...
public class ModMenuTypes {
    ...
    private static <T extends net.minecraft.world.inventory.AbstractContainerMenu> MenuType<T> registerSimple(String name, SimpleMenuFactory<T> factory) {
        ...
        return Registry.register(BuiltInRegistries.MENU, new ResourceLocation(ServerManagementModFabric.MOD_ID, name), type);
    }
    ...
    private interface ExtendedMenuFactory<T> {
        T create(int windowId, net.minecraft.world.entity.player.Inventory inv, net.minecraft.network.FriendlyByteBuf data);
    }
