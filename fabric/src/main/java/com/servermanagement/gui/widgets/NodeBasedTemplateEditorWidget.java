...
public class NodeBasedTemplateEditorWidget extends AbstractWidget {
    ...
    private void renderBezierLine(GuiGraphics guiGraphics, int x1, int y1, int x2, int y2, int color) {
        ...
        int segments = lengthSq < 40000 ? 6 : 12;
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
        for (Node n : nodes) {
            if (n.mouseScrolled(mouseX, mouseY, scrollY)) return true;
        }
        return false;
    }
    ...
    // 1.20.1: Java 17 supports records
    ...
    private abstract class Node {
        ...
        void updateWidgets() {}
        // 1.20.1: mouseScrolled 3 params
        boolean mouseScrolled(double mx, double my, double sy) { return false; }
    ...
    private class RewardNode extends Node {
        ...
        // 1.20.1: mouseScrolled 3 params
        @Override boolean mouseScrolled(double mx, double my, double sy) {
            return itemPicker.mouseScrolled(mx, my, sy);
        }
    }
}
