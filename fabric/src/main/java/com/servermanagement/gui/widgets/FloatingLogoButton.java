...
public class FloatingLogoButton extends AbstractWidget {
    ...
    // 1.20.1: use constructor instead of fromNamespaceAndPath
    private static final ResourceLocation LOGO_TEXTURE = new ResourceLocation(ServerManagementMod.MOD_ID, "textures/gui/servermanagement_logo.png");
    ...
    private void snapToNearestEdge(int sw, int sh) {
        ...
        double distLeft   = currentX;
        double distRight  = sw - (currentX + LOGO_WIDTH);
        double distTop    = currentY;
        double distBottom = sh - (currentY + LOGO_HEIGHT);
