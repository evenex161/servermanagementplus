...
public class TabListIsolationHandler {
    ...
    public static void onPlayerLogin(net.minecraft.server.level.ServerPlayer player) {
        ServerPlayer joiningPlayer = player;
     ...
     */
    public static void onPlayerChangedDimension(net.minecraft.server.level.ServerPlayer player) {
    ...
    public static void onPlayerLogout(net.minecraft.server.level.ServerPlayer player) {
        previousVisiblePlayers.remove(player.getUUID());
    }
