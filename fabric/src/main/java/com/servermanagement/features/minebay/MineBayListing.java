...
public class MineBayListing {
    ...
    public CompoundTag toNBT() {
        ...
        tag.put("ItemForSale", itemForSale.saveOptional(com.servermanagement.ServerManagementModFabric.getServer().registryAccess()));
    ...
    public static MineBayListing fromNBT(CompoundTag tag) {
        ...
        listing.itemForSale = ItemStack.parseOptional(com.servermanagement.ServerManagementModFabric.getServer().registryAccess(), tag.getCompound("ItemForSale"));
