...
public class SyncUpdateInfoPacket implements IPacket {
    ...
    private static com.servermanagement.updater.UpdateCheckResult readResult(net.minecraft.network.FriendlyByteBuf buf) {
        ...
        if (hasModrinth) {
            modrinth = new com.servermanagement.updater.UpdateInfo(
                buf.readUtf(32767), buf.readUtf(32767), buf.readUtf(32767), buf.readUtf(32767), buf.readUtf(32767)
            );
        }
    ...
    public void encode(net.minecraft.network.FriendlyByteBuf buf) {
        ...
        if (result != null && result.modrinth() != null) {
            buf.writeUtf(result.modrinth().version() != null ? result.modrinth().version() : "", 32767);
            buf.writeUtf(result.modrinth().downloadUrl() != null ? result.modrinth().downloadUrl() : "", 32767);
            buf.writeUtf(result.modrinth().changelog() != null ? result.modrinth().changelog() : "", 32767);
            buf.writeUtf(result.modrinth().releaseDate() != null ? result.modrinth().releaseDate() : "", 32767);
            buf.writeUtf(result.modrinth().source() != null ? result.modrinth().source() : "", 32767);
        }
        buf.writeBoolean(result != null && result.curseforge() != null);
        if (result != null && result.curseforge() != null) {
            buf.writeUtf(result.curseforge().version() != null ? result.curseforge().version() : "", 32767);
            buf.writeUtf(result.curseforge().downloadUrl() != null ? result.curseforge().downloadUrl() : "", 32767);
            buf.writeUtf(result.curseforge().changelog() != null ? result.curseforge().changelog() : "", 32767);
            buf.writeUtf(result.curseforge().releaseDate() != null ? result.curseforge().releaseDate() : "", 32767);
            buf.writeUtf(result.curseforge().source() != null ? result.curseforge().source() : "", 32767);
        }
        buf.writeUtf(result != null && result.currentVersion() != null ? result.currentVersion() : "", 32767);
