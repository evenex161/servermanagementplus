...
public class ModConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue WORLD_MANAGER_ENABLED;

    public static final ForgeConfigSpec.BooleanValue NETHER_PORTALS_ENABLED;

    public static final ForgeConfigSpec.BooleanValue END_PORTALS_ENABLED;

    public static final ForgeConfigSpec.BooleanValue WORLD_TIMERS_ENABLED;

    public static final ForgeConfigSpec.BooleanValue CHAT_ISOLATION_ENABLED;

    public static final ForgeConfigSpec.BooleanValue TAB_ISOLATION_ENABLED;
    ...
    public static final ForgeConfigSpec.BooleanValue PLAYER_MANAGER_ENABLED;

    public static final ForgeConfigSpec.BooleanValue SPECTATE_ENABLED;

    public static final ForgeConfigSpec.BooleanValue VIEW_INVENTORY_ENABLED;

    public static final ForgeConfigSpec.BooleanValue SLIME_HEADS_ENABLED;



    // Economy Settings

    public static final ForgeConfigSpec.BooleanValue ECONOMY_ENABLED;

    public static final ForgeConfigSpec.DoubleValue STARTING_BALANCE;

    public static final ForgeConfigSpec.BooleanValue ENCRYPTED_STORAGE;

    public static final ForgeConfigSpec.IntValue TRANSACTION_HISTORY_LIMIT;
    ...
    public static final ForgeConfigSpec.BooleanValue SERVER_PERFORMANCE_ENABLED;



    // MOTD Settings

    public static final ForgeConfigSpec.BooleanValue MOTD_ENABLED;

    public static final ForgeConfigSpec.BooleanValue ITEM_MERGING_ENABLED;

    public static final ForgeConfigSpec.DoubleValue ITEM_MERGE_RADIUS;

    public static final ForgeConfigSpec.IntValue ITEM_MERGE_INTERVAL;

    public static final ForgeConfigSpec.BooleanValue MOB_SPAWN_LIMITER_ENABLED;

    public static final ForgeConfigSpec.IntValue MOB_CAP_MULTIPLIER;

    public static final ForgeConfigSpec.BooleanValue ENTITY_ACTIVATION_RANGE_ENABLED;

    public static final ForgeConfigSpec.IntValue MONSTER_ACTIVATION_RANGE;

    public static final ForgeConfigSpec.IntValue ANIMAL_ACTIVATION_RANGE;

    public static final ForgeConfigSpec.IntValue MISC_ACTIVATION_RANGE;

    public static final ForgeConfigSpec.BooleanValue VILLAGER_THROTTLE_ENABLED;

    public static final ForgeConfigSpec.IntValue VILLAGER_TICK_INTERVAL;

    public static final ForgeConfigSpec.BooleanValue REDSTONE_THROTTLE_ENABLED;

    public static final ForgeConfigSpec.IntValue REDSTONE_UPDATES_PER_TICK;

    public static final ForgeConfigSpec.BooleanValue TPS_MONITOR_ENABLED;

    public static final ForgeConfigSpec.DoubleValue TPS_WARNING_THRESHOLD;

    public static final ForgeConfigSpec.DoubleValue TPS_CRITICAL_THRESHOLD;

    public static final ForgeConfigSpec.BooleanValue TPS_AUTO_OPTIMIZE;



    // Chunk Gen Throttle (DH synergy)

    public static final ForgeConfigSpec.BooleanValue CHUNK_GEN_THROTTLE_ENABLED;
    ...
    public static final ForgeConfigSpec.BooleanValue MOVEMENT_LENIENCY_ENABLED;

    public static final ForgeConfigSpec.IntValue MOVEMENT_LENIENCY_MULTIPLIER;



    // Dynamic View Distance

    public static final ForgeConfigSpec.BooleanValue DYNAMIC_VIEW_DISTANCE_ENABLED;

    public static final ForgeConfigSpec.IntValue VIEW_DISTANCE_REDUCTION;
