...
public class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(com.servermanagement.gui.ModMenuTypes.ACHIEVEMENTS_MENU.get(), com.servermanagement.gui.economy.AchievementsScreen::new);
            MenuScreens.register(com.servermanagement.gui.ModMenuTypes.ECONOMY_MANAGEMENT_MENU.get(), com.servermanagement.gui.economy.EconomyManagementScreen::new);
            MenuScreens.register(com.servermanagement.gui.ModMenuTypes.MINEBAY_MENU.get(), com.servermanagement.gui.minebay.MineBayScreen::new);
            MenuScreens.register(ModMenuTypes.MINESTACKS_MENU.get(), com.servermanagement.gui.gambling.MineStacksScreen::new);
            MenuScreens.register(ModMenuTypes.UPDATER_MENU.get(), com.servermanagement.gui.screen.UpdaterScreen::new);
            MenuScreens.register(ModMenuTypes.PERFORMANCE_SETTINGS_MENU.get(), PerformanceSettingsScreen::new);
            MenuScreens.register(ModMenuTypes.MOTD_EDITOR_MENU.get(), MotdEditorScreen::new);
